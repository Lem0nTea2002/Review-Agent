...
class Settings:
    ...
    projects_file: str = ""
    ocr_command: str = ""
    ocr_version: str = "1.8.5"
    ocr_timeout_seconds: int = 120
    ocr_max_output_bytes: int = 2 * 1024 * 1024
    ocr_env_allowlist: str = ""
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            projects_file=os.getenv("EVOAGENT_PROJECTS_FILE", ""),
            ocr_command=os.getenv("EVOAGENT_OCR_COMMAND", ""),
            ocr_version=os.getenv("EVOAGENT_OCR_VERSION", "1.8.5"),
            ocr_timeout_seconds=_int("EVOAGENT_OCR_TIMEOUT_SECONDS", 120),
            ocr_max_output_bytes=_int("EVOAGENT_OCR_MAX_OUTPUT_BYTES", 2 * 1024 * 1024),
            ocr_env_allowlist=os.getenv("EVOAGENT_OCR_ENV_ALLOWLIST", ""),
        )
